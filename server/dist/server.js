...
function initServer() {
    ...
    app
        .route('/api/checkout')
        .post(bodyParser.json(), get_user_middleware_1.getUserMiddleware, checkout_route_1.createCheckoutSession);
    app
        .route('/stripe-webhooks')
        .post(bodyParser.raw({ type: 'application/json' }), stripe_webhooks_route_1.stripeWebhooks);
